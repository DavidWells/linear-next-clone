        ...
        <div className="font-medium text-sm w-full text-gray-700 flex items-center">
          <span className="flex items-center justify-center w-4 h-4 bg-gray-200 rounded-full">
            <svg width="4" height="9" viewBox="0 0 3 9">
              <path d="M0.920455 9H1.92614V2.45455H0.920455V9ZM1.43182 1.38068C1.82386 1.38068 2.14773 1.07386 2.14773 0.698864C2.14773 0.323864 1.82386 0.0170453 1.43182 0.0170453C1.03977 0.0170453 0.715909 0.323864 0.715909 0.698864C0.715909 1.07386 1.03977 1.38068 1.43182 1.38068Z" />
            </svg>
          </span>
